<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex justify-center space-x-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 w-1/2">
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Gerar Pagamento</h3>
                @if ($errors->any())
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 w-1/2">
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Cadastrar Empresa</h3>
                @if ($errors->any())
                    <div class="mb-4 p-4 bg-red-100 text-red-800 rounded dark:bg-red-900 dark:text-red-200">
                        <ul class="list-disc pl-5 space-y-1">
                            @foreach ($errors->all() as $error)
                ...
                <form action="{{ route('payments.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="company_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nome da Empresa</label>
                    ...
                    <div class="mb-4">
                        <label for="api_secret" class="block text-sm font-medium text-gray-700 dark:text-gray-300">API Secret</label>
                        <input type="text" name="api_secret" id="api_secret" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>

                    <div class="mb-4">
                        <label for="return_url" class="block text-sm font-medium text-gray-700 dark:text-gray-300">URL de Retorno</label>
                        <input type="text" name="return_url" id="return_url" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>

                    <div class="mb-4">
                        <label for="cancel_url" class="block text-sm font-medium text-gray-700 dark:text-gray-300">URL de Cancelamento</label>
